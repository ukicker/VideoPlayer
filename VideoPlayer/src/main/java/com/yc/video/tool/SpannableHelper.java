...
public class SpannableHelper {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setBackgroundColor(@ColorInt int color, @ColorInt int foregroundColor, int radius) {
            this.backgroundColor = color;
         ...
         * ds.setColor(Color.parseColor(R.color.theme_green));
        ...
        private void setSpan() {
            ...
            if (size != -1) {
                mBuilder.setSpan(new AbsoluteSizeSpan(sp2px(context, size)), start, end, flag);
                size = -1;
            }
            if (backgroundRadius > 0) {
                mBuilder.setSpan(new RoundBackgroundColorSpan(backgroundColor, foregroundColor, backgroundRadius), start, end, flag);
                backgroundColor = defaultValue;
                foregroundColor = defaultValue;
                backgroundRadius=0;
            } else {
    ...
    public static class RoundBackgroundColorSpan extends ReplacementSpan {
        ...
        public RoundBackgroundColorSpan(int backgroundColor, int radius) {
            this.backgroundColor = backgroundColor;
            this.radius = radius;
        }
