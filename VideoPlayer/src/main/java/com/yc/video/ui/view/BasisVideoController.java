...
public class BasisVideoController extends GestureVideoController implements View.OnClickListener {
    ...
    public void showError(String massage){
        for (InterControlView controlView:mControlComponents.keySet()) {
            if (controlView instanceof CustomErrorView){
                CustomErrorView errorView= (CustomErrorView) controlView;
                errorView.showError(massage);
            }
        }
    }

    public void addDefaultTitle(String title){
    ...
    protected int getLayoutId() {
        return R.layout.player_custom_video_standard;
    }
    ...
    public void addDefaultControlComponent(String title) {
        ...
        //手势引导
        CustomGuideView guideView = new CustomGuideView(mContext);
        guideView.setLive(isLive);
        this.addControlComponent(guideView);

        //画中画
        CustomPipControlView customControlView = new CustomPipControlView(mContext);
        customControlView.setVisibility(GONE);
        this.addControlComponent(customControlView);
    ...
    protected void onPlayerStateChanged(int playerState) {
        ...
        VideoLogUtils.e("onPlayerStateChanged 屏幕模式:" + playerState);
        switch (playerState) {
    ...
    public boolean onBackPressed() {
        if (isLocked()) {
            show();
            String string = mContext.getResources().getString(R.string.player_lock_tip);
