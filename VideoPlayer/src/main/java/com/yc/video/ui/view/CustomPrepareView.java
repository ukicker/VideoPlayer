...
public class CustomPrepareView extends FrameLayout implements InterControlView {
    ...
    private LinearLayout mLlNetWarning;
    ...
    private void init(Context context){
        ...
        View view = LayoutInflater.from(getContext()).inflate(
                R.layout.player_custom_video_player_prepare, this, true);
    ...
    private void initFindViewById(View view) {
        ...
        mLlNetWarning = view.findViewById(R.id.fl_net_warning);
    ...
    private void initListener() {
        mTvStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mLlNetWarning.setVisibility(GONE);
    ...
    public void onPlayStateChanged(int playState) {
        switch (playState) {
            ...
            case ConstantKeys.CurrentState.STATE_START_ABORT:
                setVisibility(VISIBLE);
                mLlNetWarning.setVisibility(VISIBLE);
                mLlNetWarning.bringToFront();
                break;
        }
    }
