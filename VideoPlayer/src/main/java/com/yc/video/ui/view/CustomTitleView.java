...
public class CustomTitleView extends FrameLayout implements InterControlView, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        setVisibility(GONE);
        View view = LayoutInflater.from(mContext).inflate(R.layout.player_custom_video_player_top, this, true);
    ...
    public void onVisibilityChanged(boolean isVisible, Animation anim) {
        //只在全屏时才有效
        if (mControlWrapper.isFullScreen()&&isVisible) {
    ...
    public void onPlayerStateChanged(int playerState) {
        ...
        } else if (playerState == ConstantKeys.PlayMode.MODE_TINY_WINDOW) {
            setVisibility(GONE);
        }
